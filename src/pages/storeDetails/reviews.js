    ...
    return (
                ...
                <Row>
                    ...
                    <Col style={{flexDirection:"row",alignContent:"center"}}>
                        <Text style={{ fontWeight: 'normal', fontSize: 16 }}>
                            <Icon name='star' type="MaterialIcons" style={{ color: "#F7D54D", fontSize: 14 }} />
                            <Icon name='star' type="MaterialIcons" style={{ color: "#F7D54D", fontSize: 14 }} />
                            <Icon name='star' type="MaterialIcons" style={{ color: "#F7D54D", fontSize: 14 }} />
                            <Icon name='star' type="MaterialIcons" style={{ color: "#F7D54D", fontSize: 14 }} />
                            <Icon name='star' type="MaterialIcons" style={{ color: "#707070", fontSize: 14 }} />
                            <Text style={{ fontWeight: 'normal', fontSize: 14 }}>(300)</Text>
                        </Text>
                    </Col>
                </Row>
            </Grid>
            ...
            <Grid style={{marginTop:20,borderBottomWidth:1,borderColor:"#CCC",paddingBottom:20}}>
                <Row style={{flexDirection:"row",marginBottom:10}}>
                    ...
                    <Col style={{width:"30%"}}>
                        <Text style={{fontWeight:"bold",fontSize:14,marginTop:-5,textAlign:"center",color:"#707070"}}>68%</Text>
                    </Col>
                </Row>
                ...
                <Row style={{flexDirection:"row",marginBottom:10}}>
                    ...
                    <Col style={{width:"30%"}}>
                        <Text style={{fontWeight:"bold",fontSize:14,marginTop:-5,textAlign:"center",color:"#707070"}}>20%</Text>
                    </Col>
                </Row>
                ...
                <Row style={{flexDirection:"row",marginBottom:10}}>
                    ...
                    <Col style={{width:"30%"}}>
                        <Text style={{fontWeight:"bold",fontSize:14,marginTop:-5,textAlign:"center",color:"#707070"}}>4%</Text>
                    </Col>
                </Row>
                ...
                <Row style={{flexDirection:"row",marginBottom:10}}>
                    ...
                    <Col style={{width:"30%"}}>
                        <Text style={{fontWeight:"bold",fontSize:14,marginTop:-5,textAlign:"center",color:"#707070"}}>2%</Text>
                    </Col>
                </Row>
                ...
                <Row style={{flexDirection:"row",marginBottom:10}}>
                    ...
                    <Col style={{width:"30%"}}>
                        <Text style={{fontWeight:"bold",fontSize:14,marginTop:-5,textAlign:"center",color:"#707070"}}>6%</Text>
                    </Col>
                </Row>
            </Grid>
