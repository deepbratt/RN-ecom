...
export default function Coupons () {
  return (
    <Content style={{borderBottomWidth: 5, borderBottomColor: '#CCC'}}>
      <Grid style={styles.cpnGrid1} key={"titlecpns"+1}>
        <Row>
          <Text style={styles.productbrand}> Available Coupons </Text>
          <Right>
            <Text style={{fontSize: 12}}> Apply during checkout </Text>
          </Right>
        </Row>
      </Grid>

        {
          ...
          :
              <Grid style={{marginTop: -5, padding: 10}} key={"__"+66}>
                <Row style={{marginTop: 10}}>
                  <Text style={{fontSize: 13}}>
